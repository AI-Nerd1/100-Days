...
def is_leap(year):
  """For determining if a year has over 365 days."""
  if year % 4 == 0:
    if year % 100 == 0:
      if year % 400 == 0:
        return True
...
def days_in_month(year, month):
    """Passed to know how many days are in a month.
     Value for February is the number of days cahnges if is_leap(year) returns True """
