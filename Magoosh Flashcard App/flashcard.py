...
front_canvas.create_image(400, 263, image = card_back_image)
front_canvas.config(bg = BACKGROUND_COLOR, highlightthickness=0)
front_canvas.grid(row=0, column=0, columnspan = 2)

    #* Should be backend
front_canvas.create_text(400,50,text = "word", font = ("garamond", 40))
front_canvas.create_text(100,150,text = "meaning", font = ("Ariel", 14, "italic"))
