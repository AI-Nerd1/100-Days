...
name1 = input("Ladies first, What is your name dear: ")
name2 = input("Please enter your name Gentleman: ")

name1 = name1.lower()
name2 = name2.lower()

true_count1 = name1.count('t')+ name1.count('r') +name1.count('u')+ name1.count('e')
true_count2 = name2.count('t')+ name2.count('r') +name2.count('u')+ name2.count('e')

love_count1 = name1.count('l')+ name1.count('o') +name1.count('v')+ name1.count('e')
love_count2 = name2.count('l')+ name2.count('o') +name2.count('v')+ name2.count('e')

true_count = true_count1 + true_count2
love_count = love_count1 + love_count2
...
elif love_score > 39 or love_score < 51:
